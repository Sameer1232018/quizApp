  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<LeaderboardRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<LeaderboardRecord> photoUploadLeaderboardRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final photoUploadLeaderboardRecord =
            photoUploadLeaderboardRecordList.isNotEmpty
                ? photoUploadLeaderboardRecordList.first
                : null;
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  await photoUploadLeaderboardRecord!.reference
                                      .update(createLeaderboardRecordData(
                                    dp: _model.uploadedFileUrl,
                                  ));
