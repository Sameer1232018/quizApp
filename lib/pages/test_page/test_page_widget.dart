...
class _TestPageWidgetState extends State<TestPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      await showDialog(
        barrierColor: const Color(0x9CB4B0B0),
        context: context,
                            ...
                            Expanded(
                              child: FutureBuilder<ApiCallResponse>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  final pageViewCloudQuestResponse =
                                      snapshot.data!;

                                  return Builder(
                                    builder: (context) {
                                      final cloudQuizData =
                                          CloudQuestCall.cloudQuestions(
                                                pageViewCloudQuestResponse
                                                    .jsonBody,
                                              )
                                                  ?.where((e) =>
                                                      widget.setId ==
                                                              ...
                                                              Align(
                                                                ...
                                                                child: StreamBuilder<
                                                                    List<
                                                                        SetScoresRecord>>(
                                                                  stream:
                                                                      querySetScoresRecord(
                                                                    queryBuilder: (setScoresRecord) =>
                                                                        setScoresRecord
                                                                            .where(
                                                                              'setId',
                                                                              isEqualTo: widget.setId,
                                                                            )
                                                                            .where(
                                                                              'user',
                                                                              isEqualTo: currentUserUid,
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    final submitSetScoresRecord = submitSetScoresRecordList
                                                                            .isNotEmpty
                                                                        ? submitSetScoresRecordList
                                                                            .first
                                                                        : null;
                                                                    ...
                                                                    return FFButtonWidget(
                                                                      onPressed:
                                                                        ...
                                                                        await submitSetScoresRecord!
                                                                            .reference
                                                                            .update(createSetScoresRecordData(
                                                                          setScore:
                                                                              valueOrDefault<int>(
                                                                            _model.quizScore ~/
                                                                                2,
                                                                        ...
                                                                        await columnLeaderboardRecord
                                                                          ...
                                                                          ...mapToFirestore(
                                                                            {
                                                                              'totalScore': FieldValue.increment(_model.quizScore),
                                                                            },
                                                                          ),
                                                                        });
                                                                    ...
                                                                    if (_model
                                                                      ...
                                                                      ScaffoldMessenger.of(
                                                                        ...
                                                                        SnackBar(
                                                                          content:
                                                                              Text(
                                                                            'Quiz over. You can submit the quiz',
                                                                            style:
                                                                                TextStyle(
