...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'sets_page',
          path: '/setsPage',
          builder: (context, params) => SetsPageWidget(
        ...
        FFRoute(
          name: 'submitPage',
          path: '/submitPage',
          builder: (context, params) => const SubmitPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/categoryPgae',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'categoryPgae')
              : const CategoryPgaeWidget(),
        ),
        FFRoute(
          name: 'profilePage',
          path: '/profilePage',
        ...
        FFRoute(
          name: 'randomTest',
          path: '/randomTest',
          builder: (context, params) => RandomTestWidget(
            setId: params.getParam(
              'setId',
              ParamType.String,
            ),
        ...
        FFRoute(
          name: 'dailyTestPage',
          path: '/dailyTestPage',
          builder: (context, params) => DailyTestPageWidget(
            setId: params.getParam(
              'setId',
              ParamType.String,
            ),
